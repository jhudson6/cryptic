...
class Book:
    ...
    def __init__(self,name = 'Coin Book',pairs=None,exchange=None,Table = None, loadCoins = True, interval = 86400):
        ...
        if pairs is None:
            ...
            self.wallet = [Coin(pair,exchange) for pair in pairs.values]
...
#        return self
    ...
    def createModel(self, pairs, useOrderBook=False, otherData = None):
        if any([pair.name for pair in self.pairs] not in pairs)
        return
